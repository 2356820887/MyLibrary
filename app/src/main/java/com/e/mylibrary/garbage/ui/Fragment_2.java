...
public class Fragment_2 extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        mylistlibray.setLayoutManager(new LinearLayoutManager(Fragment_2.this.getActivity(),LinearLayoutManager.VERTICAL,false));
        //3.初始化数据适配器
        myAdapter = new MyListNewsAdapter(news,Fragment_2.this.getActivity());
        //4.设置动画，默认动画
    ...
    private void initDataNews(){
        ...
        //获取token
        SharedPreferences sp = Fragment_2.this.getActivity().getSharedPreferences("logintoken",MODE_PRIVATE);
        String token = sp.getString("token","");

        //获取电影列表的URL
        String url = "http://124.93.196.45:10001/prod-api/api/garbage-classification/news/list?type=8&pageNum=1&pageSize=10";
        //第一步获取okHttpClient对象
