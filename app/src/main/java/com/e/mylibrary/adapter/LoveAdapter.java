...
public class LoveAdapter extends RecyclerView.Adapter<LoveAdapter.MyViewHolder> {
    ...
    public LoveAdapter(List<Love> pdata, Context context) {
        this.pdata = pdata;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       ...
       /* holder.loveName2.setText(love.getName());
        ...
        holder.activityAt2.setText(love.getActivityAt());
        holder.moneyNow2.setText(love.getMoneyNow());
        holder.description2.setText(love.getDescription());
        holder.donateCount2.setText(love.getDonateCount());*/
        ...
        holder.loveName2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
